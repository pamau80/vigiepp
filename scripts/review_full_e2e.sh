#!/usr/bin/env bash
# Revisión E2E completa — todos los módulos API VigiEPP v50
set -euo pipefail
...
echo "=== VigiEPP FULL API Review v50 ==="
...
echo "$H" | $PY -c "import sys,json; d=json.load(sys.stdin); assert d['build']=='v50'" && ok "health v50" || bad "health"
