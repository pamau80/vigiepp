#!/usr/bin/env bash
# Revisión E2E completa — todos los módulos API VigiEPP v51
set -euo pipefail
...
echo "=== VigiEPP FULL API Review v51 ==="
...
echo "$H" | $PY -c "import sys,json; d=json.load(sys.stdin); assert d['build']=='v51'" && ok "health v51" || bad "health"
