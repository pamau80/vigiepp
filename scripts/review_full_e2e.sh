#!/usr/bin/env bash
# Revisión E2E completa — todos los módulos API VigiEPP v57
set -euo pipefail
...
echo "=== VigiEPP FULL API Review v57 ==="
...
echo "$H" | $PY -c "import sys,json; d=json.load(sys.stdin); assert d['build']=='v57'" && ok "health v57" || bad "health"
