#!/usr/bin/env bash
# Revisión E2E completa — todos los módulos API VigiEPP v52
set -euo pipefail
...
echo "=== VigiEPP FULL API Review v52 ==="
...
echo "$H" | $PY -c "import sys,json; d=json.load(sys.stdin); assert d['build']=='v52'" && ok "health v52" || bad "health"
