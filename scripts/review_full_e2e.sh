#!/usr/bin/env bash
# Revisión E2E completa — todos los módulos API VigiEPP v65
set -euo pipefail
...
echo "=== VigiEPP FULL API Review v65 ==="
...
echo "$H" | $PY -c "import sys,json; d=json.load(sys.stdin); assert d['build']=='v65'; assert 'excellence' in d" && ok "health v65" || bad "health"
