#!/usr/bin/env bash
# Revisión E2E completa — todos los módulos API VigiEPP v56
set -euo pipefail
...
echo "=== VigiEPP FULL API Review v56 ==="
...
echo "$H" | $PY -c "import sys,json; d=json.load(sys.stdin); assert d['build']=='v56'" && ok "health v56" || bad "health"
