...
export function createAppElements() {
  return {
    ...
    teachChecklist: $("#teachChecklist"),
    teachSteps: $("#teachSteps"),
    teachModelBadge: $("#teachModelBadge"),
    ...
    dayZeroWizard: $("#dayZeroWizard"),
    dayZeroBody: $("#dayZeroBody"),
    dayZeroTitle: $("#dayZeroTitle"),
    dayZeroProgress: $("#dayZeroProgress"),
    dayZeroBanner: $("#dayZeroBanner"),
    btnDayZeroBack: $("#btnDayZeroBack"),
    btnDayZeroNext: $("#btnDayZeroNext"),
    btnDayZeroSkip: $("#btnDayZeroSkip"),
    btnDayZeroReopen: $("#btnDayZeroReopen"),
    btnDayZeroReset: $("#btnDayZeroReset"),
    cfgSkinPicker: $("#cfgSkinPicker"),
    ...
    actionsDesk: $("#actionsDesk"),
    actionsRuleList: $("#actionsRuleList"),
    actionsStats: $("#actionsStats"),
    actionsHint: $("#actionsHint"),
    actionsPresetSelect: $("#actionsPresetSelect"),
    btnActionsAddPreset: $("#btnActionsAddPreset"),
    btnActionsReset: $("#btnActionsReset"),
    btnActionsOpenZones: $("#btnActionsOpenZones"),
    actionsDetail: $("#actionsDetail"),
    actionsMetersPerPixel: $("#actionsMetersPerPixel"),
    actionsCalibHint: $("#actionsCalibHint"),
    actionsTeachList: $("#actionsTeachList"),
    btnActionsOpenTeach: $("#btnActionsOpenTeach"),
    actionsAudioEnabled: $("#actionsAudioEnabled"),
    actionsEventList: $("#actionsEventList"),
    btnActionsRefreshEvents: $("#btnActionsRefreshEvents"),
